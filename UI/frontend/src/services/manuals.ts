...
export const MANUALS: ManualRef[] = [
  ...
  },
  {
    ...
    causeIds: ['etch-edgeloc-1', 'etch-random-1'],
  },
  {
    ...
    causeIds: ['etch-center-1', 'etch-donut-1', 'etch-loc-1'],
  },
  {
    ...
    causeIds: ['deposition-loc-1', 'deposition-center-2'],
  },
  {
    id: 'm-depo-rf',
    process: 'DEPOSITION',
    ...
    causeIds: ['deposition-center-1', 'deposition-edgering-1', 'deposition-nearfull-2'],
  },
  {
    id: 'm-depo-fwe',
    process: 'DEPOSITION',
    ...
    causeIds: ['deposition-edgeloc-1', 'deposition-nearfull-1'],
  },
  {
    id: 'm-photo-ebr',
    process: 'PHOTO',
    ...
    causeIds: ['photo-edgering-1', 'photo-edgeloc-2'],
  },
  {
    id: 'm-photo-coater',
    process: 'PHOTO',
  ...
  },
  {
    ...
    causeIds: ['cmp-loc-1', 'cmp-donut-2', 'cmp-nearfull-2'],
  },
  {
    id: 'm-cmp-head',
    process: 'CMP',
  ...
  },
  {
    ...
    causeIds: ['diffusion-edgering-1', 'diffusion-edgering-2'],
  },
  {
    id: 'm-clean-rinse',
    process: 'CLEANING',
    ...
    causeIds: ['cleaning-donut-1', 'cleaning-edgering-1'],
  },
  {
    id: 'm-common-robot',
    process: 'ETCH',
    ...
    causeIds: ['diffusion-scratch-2', 'deposition-scratch-2', 'photo-scratch-2', 'etch-scratch-2'],
  },
  {
    id: 'm-common-gate',
    process: 'ETCH',
    ...
    causeIds: ['deposition-edgeloc-2', 'etch-edgeloc-2'],
  },
];
